...
window.addEventListener('load', function(){
    ...
    // clase inputHandler, permite reconocer cuando una tecla es precionada o se suelta una tecla
    class InputHandler{
        constructor(game){
            this.game = game;
            ...
            // escucha cuando una tecla se deja de precionar
    ...
    class Projectile{
        ...
        draw(context){
            if(this.game.debug) context.fillStyle = 'cyan';
    ...
    class UI{
        ...
        draw(context){
            ...
            context.fillText('Puntuaje: ' + this.game.score, 20, 40);
